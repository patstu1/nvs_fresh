...
/// Main Live screen for video rooms and streaming
/// Uses BellGothic and MagdaCleanMono fonts [[memory:4642926]]
class NvsLiveScreen extends StatefulWidget {
  const NvsLiveScreen({super.key});

  @override
  State<NvsLiveScreen> createState() => _NvsLiveScreenState();
}

class _NvsLiveScreenState extends State<NvsLiveScreen>
