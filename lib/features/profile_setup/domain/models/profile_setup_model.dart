// lib/features/profile_setup/domain/models/profile_setup_model.dart
...
class ProfileSetup {
  ...
  static ProfileSetup fromJson(Map<String, dynamic> json) {
    return ProfileSetup(
      ...
      hasVerifiedStatus: json['hasVerifiedStatus'] as bool?,
      instagram: json['instagram'] as String?,
      twitter: json['twitter'] as String?,
      spotify: json['spotify'] as String?,
      enableNSFW: json['enableNSFW'] as bool?,
      offerSessions: json['offerSessions'] as bool?,
      allowTripPlanner: json['allowTripPlanner'] as bool?,
    );
  }
}
