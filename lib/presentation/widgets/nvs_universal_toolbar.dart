...
class _NVSUniversalToolbarState extends State<NVSUniversalToolbar>
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        // Top turquoise line
        Container(height: 1, color: const Color(0xFF2E8B8B)),
  ...
  Widget _buildToolbarIcon({
    ...
    final isPressed = _pressedIcon == index;
    final isHovered = _hoveredIcon == index;
