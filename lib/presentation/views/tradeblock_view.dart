// packages/grid/lib/presentation/views/tradeblock_view.dart
...
/// Main container screen for the TRADEBLOCK experience
/// Handles primary app layout and houses the core gallery component
class TradeblockView extends ConsumerStatefulWidget {
  const TradeblockView({super.key, this.onExploreNavigate, this.onSearchNavigate});

  final VoidCallback? onExploreNavigate;
  final void Function(String query)? onSearchNavigate;

  @override
  ConsumerState<TradeblockView> createState() => _TradeblockViewState();
}

class _TradeblockViewState extends ConsumerState<TradeblockView> {
