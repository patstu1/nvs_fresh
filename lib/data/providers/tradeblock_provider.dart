// packages/grid/lib/data/providers/tradeblock_provider.dart

import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:nvs/meatup_core.dart';
import '../models/vibe_lens_types.dart';

/// Provider for tradeblock profiles based on VibeLens filter
final tradeblockProfilesProvider = StateNotifierProvider.family<TradeblockProfilesNotifier,
    AsyncValue<List<UserProfile>>, VibeLensType>((ref, lens) => TradeblockProfilesNotifier(lens));

/// State notifier for managing tradeblock profiles
class TradeblockProfilesNotifier extends StateNotifier<AsyncValue<List<UserProfile>>> {
  ...
  TradeblockProfilesNotifier(this.lens) : super(const AsyncValue.loading()) {
    _loadProfiles();
  }
