...
import { SexualRole, DatingIntent } from './ConnectPreferencesTypes';
...
const BasicsTabContent = ({
  ...
  handleSelectOption: <T extends string>(field: keyof typeof formData, value: T) => void
}) => {
  const isOptionSelected = <T extends string>(field: keyof typeof formData, value: T): boolean => {
